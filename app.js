...
async function handleAddProductSubmit(e) {
  ...
  const tipo = document.getElementById("prod-tipo") ? document.getElementById("prod-tipo").value.trim() : "";
  const material = document.getElementById("prod-material") ? document.getElementById("prod-material").value.trim() : "";
  const atributo = document.getElementById("prod-atributo") ? document.getElementById("prod-atributo").value.trim() : "";
  ...
  tempPlanoMaterials.forEach((m) => {
    ...
    tr.onclick = () => {
      ...
      if (item.lab && item.lab !== currentLab) {
        ...
        // if user switches lab, switch back to 'inventario' tab automatically
        switchSubTab('geral', 'inventario');
      } else {
        switchSubTab('geral', 'inventario');
      }
      renderInventory();
